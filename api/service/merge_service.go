...
type IServiceMerge interface {
	...
	PostClientData(url string, data []map[string]interface{}) (*models.HubSpotDeal, error)
}
...
func (service *Serv) PostClientData(url string, data []map[string]interface{}) (*models.HubSpotDeal, error) {
